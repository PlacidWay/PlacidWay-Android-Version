...
{
    ArrayList<AverageCenterInfo> a_Medinfo = new ArrayList<AverageCenterInfo>();
    ...
    public PriceListAdapter(Activity activity, View v, ArrayList<AverageCenterInfo> medArray)
    {
