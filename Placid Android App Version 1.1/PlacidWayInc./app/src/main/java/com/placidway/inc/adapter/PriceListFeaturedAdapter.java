...
public class PriceListFeaturedAdapter extends BaseAdapter
{
    ArrayList<FeaturedCenterInfo> a_Medinfo = new ArrayList<FeaturedCenterInfo>();
    ...
    public PriceListFeaturedAdapter(Activity activity, View v,ArrayList<FeaturedCenterInfo> medArray)
    {
...
//		return idlist.size();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.plist, null);
            ...
            holder.tv_price =(TextView)vi.findViewById(R.id.tv_price); // thumb image
            ...
            holder.tv_description.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tv_title.setText(a_Medinfo.get(pos).getCenter_name().toString());

                    TextView tv_description = (TextView) dialog.findViewById(R.id.tv_dialog_description);
                    tv_description.setText(a_Medinfo.get(pos).getDetails().toString());

                    TextView tv_price = (TextView) dialog.findViewById(R.id.tv_dialog_price);
                    tv_price.setText("$ "+a_Medinfo.get(pos).getPrice().toString());
        ...
        holder.tv_title.setText(a_Medinfo.get(position).getCenter_name().toString()); // title
        holder.tv_description.setText(a_Medinfo.get(position).getDetails().toString()); // description
        holder.tv_price.setText("$ "+a_Medinfo.get(position).getPrice().toString()); // description


        ImageLoader.getInstance().displayImage(a_Medinfo.get(position).getImg_url(), holder.img_pic);
